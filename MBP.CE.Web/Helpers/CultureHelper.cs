...
namespace MBP.CE.Web.Helpers
{
    public static class CultureHelper
    {
        ...
        "pt-PT",  // first culture is the DEFAULT (Português)
        ...
        /// <summary>
        /// Returns a valid culture name based on "name" parameter. If "name" is not valid, it returns the default culture "pt-PT"
        /// </summary>
        ...
        public static IEnumerable<LanguageModel> GetLanguages()
        {
            ...
            foreach (var culture in GetImplementedCultures())
            {
                languages.Add(new LanguageModel
                {
                    ...
                    IsCurrent = culture.Name == currentCulture
                });
            }
